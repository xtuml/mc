...
$BPHOMEDIR/bridgepoint --launcher.suppressErrors -vm $BP_JVM -clean -noSplash -data $WORKSPACE -application $APPLICATION $2 "$3" $4 "$5" $6 "$7" $8 "$9"
