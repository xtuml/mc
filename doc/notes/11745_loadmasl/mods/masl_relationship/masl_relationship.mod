domain masl_relationship is
  ...
  relationship R1701 is AssociativeRelationshipDeclaration unconditionally XX one Z_ObjectDeclaration_relationship, Z_ObjectDeclaration_relationship unconditionally YY one AssociativeRelationshipDeclaration;
  ...
  relationship R1703 is AssociativeRelationshipDeclaration unconditionally XX one Z_Domain_relationship, Z_Domain_relationship unconditionally YY one AssociativeRelationshipDeclaration;
  relationship R1704 is HalfRelationship unconditionally XX one Z_ObjectNameExpression_relationship, Z_ObjectNameExpression_relationship unconditionally YY one HalfRelationship;
  ...
  relationship R1706 is HalfRelationship unconditionally XX one Z_ObjectNameExpression_relationship, Z_ObjectNameExpression_relationship unconditionally YY one HalfRelationship;
  ...
  relationship R1709 is NormalRelationshipDeclaration unconditionally XX one Z_Domain_relationship, Z_Domain_relationship unconditionally YY one NormalRelationshipDeclaration;
  ...
  relationship R1711 is RelationshipSpecification unconditionally XX one Z_ObjectDeclaration_relationship, Z_ObjectDeclaration_relationship unconditionally YY one RelationshipSpecification;
  ...
  relationship R1714 is RelationshipSpecification unconditionally XX one Z_ObjectDeclaration_relationship, Z_ObjectDeclaration_relationship unconditionally YY one RelationshipSpecification;
  ...
  relationship R1716 is SubtypeRelationshipDeclaration unconditionally XX many Z_ObjectDeclaration_relationship, Z_ObjectDeclaration_relationship unconditionally YY one SubtypeRelationshipDeclaration;
  relationship R1717 is SubtypeRelationshipDeclaration unconditionally XX one Z_ObjectDeclaration_relationship, Z_ObjectDeclaration_relationship unconditionally YY one SubtypeRelationshipDeclaration;
  relationship R1718 is SubtypeRelationshipDeclaration unconditionally XX one Z_Domain_relationship, Z_Domain_relationship unconditionally YY one SubtypeRelationshipDeclaration;
