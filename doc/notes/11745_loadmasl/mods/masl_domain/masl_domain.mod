domain masl_domain is
  ...
  object Z_ObjectService_domain;
  object Z_BasicType_domain;
  object Z_ProjectTerminatorService_domain;
  relationship R5200 is ParameterDefinition unconditionally is_typed_by one Z_BasicType_domain, Z_BasicType_domain conditionally types many ParameterDefinition;
  ...
  relationship R5203 is Service is_a ( DomainService, DomainTerminatorService, Z_ObjectService_domain, Z_ProjectTerminatorService_domain );
  ...
  relationship R5205 is Service unconditionally returns one Z_BasicType_domain, Z_BasicType_domain conditionally is_returned_by many Service;
  relationship R5206 is Service conditionally raises many ExceptionReference, ExceptionReference conditionally is_raised_by many Service;
  ...
  relationship R5400 is ExceptionDeclaration unconditionally catches_errors_in one Domain, Domain conditionally has_errors_caught_by many ExceptionDeclaration;
  ...
  //!IMPORTED
  object Z_ObjectService_domain is
  ...
  //!IMPORTED
  object Z_ProjectTerminatorService_domain is
