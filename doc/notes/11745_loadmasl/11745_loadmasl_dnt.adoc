...
. layout
  ...
  .. Split 'expression' into 'expression', 'binary', 'invocation',
     'simple' and 'literal'.
     ...
     ... 'simple' DictionaryAccessExpression, DictionaryContainsExpression,
         DictionaryKeysExpression, DictionaryValuesExpression,
         TimeFieldExpression, TimerFieldExpression,
         TimestatmpDeltaExpression,
         ParameterNameExpression, TerminatorNameExpression,
