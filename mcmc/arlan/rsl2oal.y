...
code:
        /* empty */
        | code statement { printf( "rox1 %s rox2\n", $2 ); }
        | code comment
        | code literal
        ;
...
statement:
        ...
        | FUNCTION identifier '\n' fparameters fbody ENDFUNCTION '\n' /* { $$ = stradd( stradd( stradd( stradd( stradd( stradd( $1, $2 ), $3 ), $4 ), $5 ), $6 ), $7 ); } */
        ...
        | EXITTOK sexpr '\n' {P(" );\n")}
        | EMIT string '\n' {P(" );\n")}
        | ASSIGN variable '=' expr '\n' {$$ = stradd( stradd( stradd( stradd( $1, $2 ), $3 ), $4), $5 );}
...
sexpr:
        UOP term
        | '-' term %prec UMINUS
        | term bop expr { $$ = stradd( stradd( $1, $2 ), $3 ); }
        | term
