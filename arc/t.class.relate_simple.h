...
${externstatic}void ${relate_method.name}( ${part_te_class.GeneratedName} *, ${form_te_class.GeneratedName} *${thismodule} );
.else
...
${externstatic}void ${unrelate_method.name}( ${part_te_class.GeneratedName} *, ${form_te_class.GeneratedName} *${thismodule} );
.else
