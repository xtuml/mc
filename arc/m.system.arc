...
.function mark_all
  ...
  .if ( "1" == pass )
    ...
    .elif ( "specify_user_defined_enum_type_as_external_macro" == f )
      ...
      .invoke specify_user_defined_enum_type_as_external_macro(p1,p2,p3,p4)
    .elif ( "specify_user_defined_type" == f )
      .// specify_user_defined_type("dt_name","ext_name","initial_value","include_file")
      .invoke specify_user_defined_type(p1,p2,p3,p4)
    .else
      .// not in this pass
    .end if
  .else
    ...
    .elif ( "ExcludePackageFromCodeGen" == f )
      .// ExcludePackageFromCodeGen("component_name","subsystem_name")
      .invoke ExcludePackageFromCodeGen(p1,p2)
    ...
    .elif ( "SetDomainEventMaxNumber" == f )
      .// SetDomainEventMaxNumber("component_name","internalEventNum","externalEventNum")
