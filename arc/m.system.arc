...
.function mark_all
  ...
  .else
    ...
    .elif ( "port_realize_EE" == f )
      ...
      .invoke port_realize_EE(p1,p2,p3)
    ...
    .elif ( "TagBridgeCallNotGenerate" == f )
      ...
      .invoke TagBridgeCallNotGenerate(p1,p2)
    .else
      .// not in this pass
    .end if
  .end if
