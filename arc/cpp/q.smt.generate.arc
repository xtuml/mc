...
.function q_smt_for
  ...
  .invoke s = t_oal_smt_for( te_smt, te_for )
...
.function q_smt_if
  ...
  .invoke s = t_oal_smt_if( condition_te_val.buffer )
  .assign te_smt.buffer = s.body
  .assign te_smt.buffer2 = s.ending
...
.function q_smt_while
  ...
  .invoke s = t_oal_smt_while( condition.buffer )
  .assign te_smt.buffer = s.body
  .assign te_smt.buffer2 = s.ending
...
.function q_smt_elif
  ...
  .invoke s = t_oal_smt_elif( condition.buffer )
  .assign te_smt.buffer = s.body
  .assign te_smt.buffer2 = s.ending
...
.function q_smt_assign
  ...
  .if ( te_assign.isImplicit )
    ...
    .end if
  .end if
  .invoke s = t_oal_smt_assign( te_smt, te_assign )
  .assign te_smt.buffer = s.body
...
.function q_smt_create_instance
  ...
  .select one te_var related by v_var->TE_VAR[R2039]
  .invoke s = t_oal_smt_create_instance( o_obj, act_cr.is_implicit, te_class.GeneratedName, te_var.buffer )
  .assign te_smt.declaration = s.declaration
  .assign te_smt.buffer = s.body
...
.function q_smt_delete_instance
  ...
  .invoke s = t_oal_smt_delete_instance( o_obj, te_var.buffer, del_count )
  .assign te_smt.buffer = s.body
...
.function q_smt_create_event
  ...
  .if ( not_empty v_pars )
    ...
    .for each v_par in v_pars
      ...
      .invoke r = t_oal_smt_event_parameters( te_var.buffer, v_par.Name, par_te_val.buffer, par_te_dt.Core_Typ )
  ...
  .if ( not_empty sm_pevt )
    ...
    .end if
  .end if
  .invoke s = t_oal_smt_create_event( sm_evt, e_ces.is_implicit, o_obj.Name, sm_evt.Mning, v_var.Name, te_var.buffer, recipient, parameters )
  .assign te_smt.declaration = s.declaration
  .assign te_smt.buffer = s.body
...
.function q_smt_relate
  ...
  .invoke s = t_oal_smt_relate( one_o_obj, oth_o_obj, r_rel, is_refl.result, r_rel.Numb, act_rel.relationship_phrase, one_te_var.buffer, oth_te_var.buffer )
  .assign te_smt.buffer = s.body
...
.function q_smt_relate_using
  ...
  .invoke s = t_oal_smt_relate_using( one_o_obj, oth_o_obj, ass_o_obj, r_rel, is_refl.result, r_rel.Numb, act_ru.relationship_phrase, one_te_var.buffer, oth_te_var.buffer, ass_te_var.buffer, one_rel_phrase, oth_rel_phrase )
  .assign te_smt.buffer = s.body
...
.function q_smt_unrelate
  ...
  .invoke is_refl = is_reflexive( r_rel )
  .invoke s = t_oal_smt_unrelate( one_o_obj, oth_o_obj, r_rel, is_refl.result, r_rel.Numb, act_unr.relationship_phrase, one_te_var.buffer, oth_te_var.buffer )
  .assign te_smt.buffer = s.body
...
.function q_smt_unrelate_using
  ...
  .select one oth_o_obj related by oth_v_var->V_INT[R814]->O_OBJ[R818]
  .select one ass_o_obj related by ass_v_var->V_INT[R814]->O_OBJ[R818]
  .invoke s = t_oal_smt_unrelate_using( one_o_obj, oth_o_obj, ass_o_obj, r_rel, is_refl.result, r_rel.Numb, act_uru.relationship_phrase, one_te_var.buffer, oth_te_var.buffer, ass_te_var.buffer, one_rel_phrase, oth_rel_phrase )
  .assign te_smt.buffer = s.body
  .assign te_smt.OAL = "UNRELATE ${one_te_var.OAL} TO ${oth_te_var.OAL} ACROSS R${r_rel.Numb} USING ${ass_te_var.OAL}"
.end function
.//
.// --------------------------------------------------------
.// select statements
...
.function q_smt_select
  ...
  .invoke s = t_oal_smt_select( o_obj, te_smt, te_select )
  .assign te_smt.declaration = s.declaration
  .assign te_smt.initialization = s.initialization
...
.function q_smt_select_where
  ...
  .invoke s = t_oal_smt_select_where( o_obj, te_smt, te_select_where )
  .assign te_smt.declaration = s.declaration
  .assign te_smt.initialization = s.initialization
  .assign te_smt.deallocation = s.deallocation
  .assign te_smt.buffer = s.body
...
.function q_smt_generate_precreated_event
  ...
  .invoke s = t_oal_smt_generate_precreated_event( self_directed, te_val.buffer )
  .assign te_smt.declaration = s.declaration
  .assign te_smt.initialization = s.initialization
  .assign te_smt.deallocation = s.deallocation
  .assign te_smt.buffer = s.body
...
.function q_smt_generate_event
  ...
  .if ( not_empty v_pars )
    ...
    .for each v_par in v_pars
      .select one par_te_dt related by v_par->V_VAL[R800]->S_DT[R820]->TE_DT[R2021]
      .select one par_te_val related by v_par->V_VAL[R800]->TE_VAL[R2040]
      .invoke r = t_oal_smt_event_parameters( "", v_par.Name, par_te_val.buffer, par_te_dt.Core_Typ )
      .assign parameters = parameters + r.result
      .assign parameter_OAL = ( parameter_OAL + delimeter ) + par_te_val.OAL
      .assign delimeter = ", "
    .end for
  ...
  .end if
  .invoke s = t_oal_smt_generate( sm_evt, self_directed, te_var.buffer, sm_evt.Drv_Lbl, sm_evt.Mning, parameters )
  .assign te_smt.declaration = s.declaration
  .assign te_smt.buffer = s.body
...
.function q_smt_generate_creator_event
  ...
  .invoke s = t_oal_smt_generate_creator_event( p.sm_evt, p.self_directed, "0", sm_evt.Drv_Lbl, sm_evt.Mning, p.parameters )
  .assign te_smt.buffer = s.body
...
.function q_smt_generate_event_to_class
  ...
  .assign sm_evt = p.sm_evt
  .assign tgt_o_obj = p.tgt_o_obj
  .invoke s = t_oal_smt_generate_to_class( p.sm_evt, p.self_directed, "0", sm_evt.Drv_Lbl, sm_evt.Mning, p.parameters )
  .assign te_smt.buffer = s.body
...
.function q_smt_sgn
  ...
  .if ( not_empty v_pars )
    ...
    .assign parameters = parameters + params.body
    .assign parameter_OAL = params.OAL
  .end if
  .assign name = ( te_mact.ComponentName + "::" ) + te_mact.GeneratedName
  .invoke s = t_oal_smt_iop( name, parameters )
  .assign te_smt.buffer = s.body
  .assign te_smt.OAL = "SEND ${te_mact.InterfaceName}::${te_mact.MessageName}(${parameter_OAL})"
.end function
.//
.// --------------------------------------------------------
...
.function q_smt_iop
  ...
  .invoke s = t_oal_smt_iop( name, parameters )
  .assign te_smt.buffer = s.body
  .assign te_smt.OAL = "${te_mact.InterfaceName}::${te_mact.MessageName}(${parameter_OAL})"
.end function
.//
.// --------------------------------------------------------
...
.function q_smt_operate
  ...
  .end if
  .invoke s = t_oal_smt_operation( instance_based, name, parameters, variable )
  .assign te_smt.buffer = s.body
  .if ( instance_based )
...
.function q_smt_bridge
  ...
  .if ( not_empty v_pars )
    ...
    .assign parameter_OAL = params.OAL
  .end if
  .assign name = ( ( s_ee.Key_Lett + "::" ) + te_brg.GeneratedName )
  .invoke s = t_oal_smt_bridge( name, parameters )
  .assign te_smt.buffer = s.body
  .assign te_smt.OAL = "${s_ee.Key_Lett}::${s_brg.Name}( ${parameter_OAL} )"
.end function
.//
.// --------------------------------------------------------
.// function statement
...
.function q_smt_function
  ...
  .if ( not_empty v_pars )
    ...
    .assign parameter_OAL = params.OAL
  .end if
  .invoke s = t_oal_smt_function( te_sync.intraface_method, parameters )
  .assign te_smt.buffer = s.body
...
.function q_smt_return
  ...
  .if (not_empty v_val)
    ...
    .select one core_s_dt related by s_dt->S_UDT[R17]->S_CDT[R18]->S_DT[R17]
    ...
    .if (s_dt.Name == "real")
      ...
      .if ( return_smt_dt_name != "" )
        ...
        .select one returnType related by v_val->S_DT[R820]
        .select one core_s_dt related by s_dt->S_UDT[R17]->S_CDT[R18]->S_DT[R17]
        .if (not_empty core_s_dt)
          .assign returnType = core_s_dt
        .end if
        .//
  ...
  .end if
  .invoke s = t_oal_smt_return( value, intCast1, intCast2 )
  .assign te_smt.buffer = s.body
...
.function q_smt_select_related
  ...
  .if ( te_select_related.is_implicit )
    .if ( "many" == te_select_related.multiplicity )
      ...
      .assign b = ""
      .include "${te_file.arc_path}/t.smt_sr.init_set.c"
      .assign te_smt.initialization = b
      .assign b = ""
