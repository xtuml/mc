...
// NOTE: Ideally VSI would create this typedef from the ARXML file.  But since the Meter
// model doesn't use it, VSI gets all smart and skips it.  So it is included here to
// make up for the VSI optimization.
