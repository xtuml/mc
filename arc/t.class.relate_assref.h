...
${externstatic}void ${link_method.name}( ${assoc_te_class.GeneratedName} *, ${assoc_te_class.GeneratedName} *, ${assr_te_class.GeneratedName} *${thismodule} );
.else
...
${externstatic}void ${unlink_method.name}( ${assoc_te_class.GeneratedName} *, ${assoc_te_class.GeneratedName} *, ${assr_te_class.GeneratedName} *${thismodule} );
.else
