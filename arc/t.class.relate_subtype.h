...
${externstatic}void ${relate_method.name}( ${super_te_class.GeneratedName} *, ${sub_te_class.GeneratedName} *${thismodule} );
.else
...
${externstatic}void ${unrelate_method.name}( ${super_te_class.GeneratedName} *, ${sub_te_class.GeneratedName} *${thismodule} );
.else
