...
masl_population_op_populate( c_t * p_element, c_t * p_value[8] )
{
  ...
  if ( ( Escher_strcmp( "project", element ) == 0 ) ) {
    ...
    if ( ( Escher_strcmp( "", value[0] ) == 0 ) ) {
      ...
      masl_parameter * p;masl_object * current_object;c_t * attr=0;c_t * obj=0;c_t * roleOrObj=0;c_t * relationship_name=0;c_t * domain_name=0;masl_attribute * referring_attr=0;masl_object * target_object=0;masl_relationship * relationship=0;masl_domain * parent_domain=0;
