--diagram.ID: ${diagram.ID}  ooaofooa_ID: ${diagram.ooaofooa_ID}  ooaofooa_path: ${diagram.path}
INSERT INTO GD_MD
	VALUES (${diagram.ID}, 
	8,                      -- Model_Type
	${diagram.ooaofooa_ID}, 		-- the id of the ooaofooa element for ISM this is the SM_SM's id
	40,                     -- OOA_TYPE
	0,
	0,
	1,
	...
	'${diagram.path}');  -- example: 'ClassDiagramOnly::ClassDiagram::class1::Instance State Machine'
