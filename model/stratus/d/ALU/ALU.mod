domain ALU is
  ...
  //! disp description here
  terminator disp is
    public service result ( value: in real, another: out real, athird: in string ) return integer;
  ...
  object Display is
    ...
    transition is
      Non_Existent ( keypress => Cannot_Happen,
                     point => Cannot_Happen,
                     operator => Cannot_Happen,
                     digit => Cannot_Happen,
                     error => Cannot_Happen,
                     reset => Cannot_Happen );       
      displaying_memory_value ( keypress => toggling_sign,
                                point => Cannot_Happen,
                                operator => Cannot_Happen,
                                digit => Cannot_Happen,
                                error => Cannot_Happen,
                                reset => displaying_memory_value );       
      toggling_sign ( keypress => toggling_sign,
  ...
  object Memory is
    ...
    public instance service store ( value: in real );     
