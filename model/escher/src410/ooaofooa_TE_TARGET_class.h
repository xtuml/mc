...
struct ooaofooa_TE_TARGET {
  ...
  c_t language[ESCHER_SYS_MAX_STRING_LEN];  
  c_t c2cplusplus_linkage_begin[ESCHER_SYS_MAX_STRING_LEN];  
  c_t c2cplusplus_linkage_end[ESCHER_SYS_MAX_STRING_LEN];  
  c_t main[ESCHER_SYS_MAX_STRING_LEN];  
