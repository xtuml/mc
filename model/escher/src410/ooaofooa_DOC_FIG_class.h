...
struct ooaofooa_DOC_FIG {
  ...
  c_t ident[ESCHER_SYS_MAX_STRING_LEN];  
...
ooaofooa_DOC_FIG * ooaofooa_DOC_FIG_op_populate(  ooaofooa_DOC_PAR *, c_t[ESCHER_SYS_MAX_STRING_LEN], c_t[ESCHER_SYS_MAX_STRING_LEN] );
