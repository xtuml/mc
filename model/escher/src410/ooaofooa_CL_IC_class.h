...
struct ooaofooa_CL_IC {
  ...
  i_t Mult;  
  c_t ClassifierName[ESCHER_SYS_MAX_STRING_LEN];  
  ...
  Escher_ObjectSet_s CL_IIR_R4700_communicates_through;
...
#define ooaofooa_CL_IIR_R4700_From_CL_IC_communicates_through( CL_IC ) ( &((CL_IC)->CL_IIR_R4700_communicates_through) )
