...
struct ooaofooa_TM_TEMPLATE {
  ...
  c_t tm_cPackage[ESCHER_SYS_MAX_STRING_LEN];  
  c_t tm_cName[ESCHER_SYS_MAX_STRING_LEN];  
  c_t tm_ifPackage[ESCHER_SYS_MAX_STRING_LEN];  
  c_t tm_ifName[ESCHER_SYS_MAX_STRING_LEN];  
  bool current;  
  c_t template_parameters[ESCHER_SYS_MAX_STRING_LEN];  
  c_t template_parameters_default[ESCHER_SYS_MAX_STRING_LEN];  
  c_t template_actual_parameters[ESCHER_SYS_MAX_STRING_LEN];  
  c_t template_default_instantiation[ESCHER_SYS_MAX_STRING_LEN];  
