...
struct ooaofooa_TE_SELECT_RELATED {
  ...
  bool by_where;  
  c_t where_clause[ESCHER_SYS_MAX_STRING_LEN];  
  c_t where_clause_OAL[ESCHER_SYS_MAX_STRING_LEN];  
  c_t multiplicity[ESCHER_SYS_MAX_STRING_LEN];  
  bool is_implicit;  
  c_t result_var[ESCHER_SYS_MAX_STRING_LEN];  
  c_t result_var_OAL[ESCHER_SYS_MAX_STRING_LEN];  
  bool start_many;  
  c_t start_var[ESCHER_SYS_MAX_STRING_LEN];  
  c_t start_var_OAL[ESCHER_SYS_MAX_STRING_LEN];  
