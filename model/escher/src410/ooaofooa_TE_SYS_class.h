...
struct ooaofooa_TE_SYS {
  ...
  i_t SystemID;  
  c_t ModelCompilerName[ESCHER_SYS_MAX_STRING_LEN];  
  c_t ExecutableName[ESCHER_SYS_MAX_STRING_LEN];  
  i_t MaxStringLen;  
  i_t MaxObjExtent;  
  i_t MaxRelExtent;  
  i_t MaxSelectExtent;  
  ...
  bool AUTOSAR;  
  bool VFB;  
  c_t SystemCPortsType[ESCHER_SYS_MAX_STRING_LEN];  
  bool AllPortsPoly;  
  c_t DomainClassNumberName[ESCHER_SYS_MAX_STRING_LEN];  
