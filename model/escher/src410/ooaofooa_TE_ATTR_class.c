...
ooaofooa_TE_ATTR_instanceloader( Escher_iHandle_t instance, const c_t * avlstring[] )
{
  ...
  Escher_strcpy( self->ParamBuffer, avlstring[ 7 ] );
  Escher_strcpy( self->Name, avlstring[ 8 ] );
  Escher_strcpy( self->GeneratedName, avlstring[ 9 ] );
  Escher_strcpy( self->DefaultValue, avlstring[ 10 ] );
  ...
  Escher_strcpy( self->array_spec, avlstring[ 14 ] );
  Escher_strcpy( self->te_classGeneratedName, avlstring[ 15 ] );
  Escher_strcpy( self->GeneratedType, avlstring[ 16 ] );
...
void ooaofooa_TE_ATTR_batch_relate( Escher_iHandle_t instance )
{
  ...
  if ( ooaofooa_TE_ATTRrelated_instance1 ) {
    ooaofooa_TE_ATTR_R2087_Link_succeeds( ooaofooa_TE_ATTRrelated_instance1, ooaofooa_TE_ATTR_instance );
  }
  }
}
