...
ooaofooa_DOC_CELL * ooaofooa_DOC_CELL_op_populate_paragraph(  ooaofooa_DOC_CELL *, c_t * );
ooaofooa_DOC_CELL * ooaofooa_DOC_CELL_op_populate_image(  c_t *, ooaofooa_DOC_CELL * );
