...
struct ooaofooa_CL_IIR {
  ...
  ooaofooa_CL_POR * CL_POR_R4708_originates_from;
};
...
void ooaofooa_CL_IIR_R4708_Link_exposes( ooaofooa_CL_POR *, ooaofooa_CL_IIR * );
void ooaofooa_CL_IIR_R4708_Unlink_exposes( ooaofooa_CL_POR *, ooaofooa_CL_IIR * );
