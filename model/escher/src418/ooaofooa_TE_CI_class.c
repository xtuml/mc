...
ooaofooa_TE_CI_instanceloader( Escher_iHandle_t instance, const c_t * avlstring[] )
{
  ...
  self->ClassifierName = Escher_strcpy( self->ClassifierName, avlstring[ 3 ] );
  self->template_parameter_values = Escher_strcpy( self->template_parameter_values, avlstring[ 4 ] );
