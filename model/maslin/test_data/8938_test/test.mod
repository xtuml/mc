domain X is
  ...
  object B is
    ...
    A_id_1: preferred referential ( R1.A.A_id_1 ) string;     
    A_id_2: preferred referential ( R1.A.A_id_2 ) string;     
  end object;
  
  object C is
    C_id: preferred integer;     
    A_id_1: preferred referential ( R2.A.A_id_1 ) string;     
    A_id_2: preferred referential ( R2.A.A_id_2 ) string;     
  end object;
