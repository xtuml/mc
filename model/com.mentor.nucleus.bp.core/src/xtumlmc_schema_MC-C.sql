-- ============================================================================
-- $RCSfile: xtumlmc_schema_MC-C.sql,v $
--
-- Description:
...
CREATE TABLE DOC_DOC (
	...
	copyright	STRING,
	filename	STRING,
	model_image_ext	STRING );

-- Class:  2301.  section
CREATE TABLE DOC_SEC (
	ID	UNIQUE_ID,
	nextID	UNIQUE_ID,
	title	STRING,
	subtitle	STRING,
...
-- Class:  2304.  footer
CREATE TABLE DOC_FOOT (
	text	STRING );

-- Class:  2305.  address
CREATE TABLE DOC_ADDR (
	street	STRING,
	city	STRING,
	state	STRING,
	postcode	STRING );

-- Class:  2306.  paragraph
...
-- ============================================================================
-- Classes In Subsystem:  Engine  
-- ============================================================================

-- Class:  9500.  Search Engine
CREATE TABLE SEN_E (
	Id	UNIQUE_ID );

-- Class:  9501.  Action Language Engine
CREATE TABLE SEN_ALE (
	Id	UNIQUE_ID );

-- Class:  9502.  Description Engine
CREATE TABLE SEN_DE (
	Id	UNIQUE_ID );

-- Class:  9503.  Declarations Engine
CREATE TABLE SEN_DCE (
	Id	UNIQUE_ID );

-- Class:  9504.  References Engine
CREATE TABLE SEN_RE (
	Id	UNIQUE_ID );
...
-- ============================================================================
-- Classes In Subsystem:  Participation  
-- ============================================================================

-- Class:  9700.  Search Participant
CREATE TABLE SP_SP (
	Id	UNIQUE_ID,
	Engine_Id	UNIQUE_ID );

-- Class:  9701.  Searchable Element
CREATE TABLE SP_SE (
	Id	UNIQUE_ID,
...
-- Class:  9702.  Action Language Searchable
CREATE TABLE SP_ALS (
	Id	UNIQUE_ID,
...
-- Class:  9601.  Declaration Query
CREATE TABLE SQU_D (
	Id	UNIQUE_ID );

-- Class:  9602.  References Query
CREATE TABLE SQU_R (
	Id	UNIQUE_ID );

-- Class:  9603.  Description Query
CREATE TABLE SQU_DE (
	Id	UNIQUE_ID );

-- Class:  9604.  Action Language Query
CREATE TABLE SQU_A (
	Id	UNIQUE_ID );
...
-- ============================================================================
-- Classes In Subsystem:  Result  
-- ============================================================================

-- Class:  9800.  Search Result
CREATE TABLE SR_SR (
	Id	UNIQUE_ID,
	Engine_Id	UNIQUE_ID,
...
-- Class:  9802.  Content Match
CREATE TABLE SR_CM (
	Id	UNIQUE_ID,
	startPosition	INTEGER,
	matchLength	INTEGER );

-- Class:  9803.  Name Match
CREATE TABLE SR_NM (
	Id	UNIQUE_ID,
	Unnamed Attribute	INTEGER );

-- Class:  9804.  Content Match Result
CREATE TABLE SR_CMR (
	Id	UNIQUE_ID,
	startPosition	INTEGER,
	length	INTEGER );
...
-- ============================================================================
-- Relationships In Subsystem:  Document  
-- ============================================================================
  
-- Note:  R2300 is unformalized (no formalizer:  R_FORM)

-- Note:  R2301 is unformalized (no formalizer:  R_FORM)

-- Note:  R2302 is unformalized (no formalizer:  R_FORM)

-- Note:  R2303 is unformalized (no formalizer:  R_FORM)

-- Note:  R2304 is unformalized (no formalizer:  R_FORM)

CREATE ROP REF_ID R2305	FROM 1C DOC_PAR	(sectionID)
			  TO 1C DOC_SEC	(ID);

CREATE ROP REF_ID R2306	FROM 1C DOC_SEC	(nextID) PHRASE 'follows'
			  TO 1C DOC_SEC	(ID) PHRASE 'precedes';

-- Note:  R2307 is unformalized (no formalizer:  R_FORM)

-- Note:  R2308 is unformalized (no formalizer:  R_FORM)

-- Note:  R2309 is unformalized (no formalizer:  R_FORM)

-- Note:  R2310 is unformalized (no formalizer:  R_FORM)

-- Note:  R2313 is unformalized (no formalizer:  R_FORM)

-- Note:  R2314 is unformalized (no formalizer:  R_FORM)

-- Note:  R2315 is unformalized (no formalizer:  R_FORM)

-- Note:  R2316 is unformalized (no formalizer:  R_FORM)

-- Note:  R2317 is unformalized (no formalizer:  R_FORM)

-- Note:  R2318 is unformalized (no formalizer:  R_FORM)

-- Note:  R2319 is unformalized (no formalizer:  R_FORM)
...
-- ============================================================================
-- Relationships In Subsystem:  Engine  
-- ============================================================================
...
-- ============================================================================
-- Relationships In Subsystem:  Participation  
-- ============================================================================
...
-- ============================================================================
-- Relationships In Subsystem:  Query  
-- ============================================================================
...
-- ============================================================================
-- Relationships In Subsystem:  Result  
-- ============================================================================
...
-- ============================================================================
-- Relationships In Subsystem:  Search  
-- ============================================================================
