...
INSERT INTO TE_EE VALUES ( ${te_ee.Name}, ${te_ee.RegisteredName}, ${te_ee.Key_Lett}, ${te_ee.Descrip}, ${te_ee.Included}, ${te_ee.file}, ${te_ee.Include_File}, ${te_ee.Used}, ${te_ee.te_cID}, ${te_ee.EE_ID}, ${te_ee.ID}, ${te_ee.nextID} );
.end for
.select many te_dts from instances of TE_DT
.for each te_dt in te_dts
INSERT INTO TE_DT VALUES ( ${te_dt.ID}, ${te_dt.Name}, ${te_dt.Core_Typ}, ${te_dt.Included}, ${te_dt.ExtName}, ${te_dt.Include_File}, ${te_dt.Initial_Value}, ${te_dt.Value}, ${te_dt.Is_Enum}, ${te_dt.Owning_Dom_Name}, ${te_dt.string_format}, ${te_dt.generated}, ${te_dt.te_cID}, ${te_dt.DT_ID} );
.end for
...
INSERT INTO TE_BRG VALUES ( ${te_brg.EEname}, ${te_brg.EEkeyletters}, ${te_brg.Name}, ${te_brg.GeneratedName}, ${te_brg.AbaID}, ${te_brg.Brg_ID}, ${te_brg.EE_ID} );
.end for
...
INSERT INTO TE_PO VALUES ( ${te_po.ID}, ${te_po.Name}, ${te_po.GeneratedName}, ${te_po.InterfaceName}, ${te_po.PackageName}, ${te_po.Provision}, ${te_po.polymorphic}, ${te_po.sibling}, ${te_po.Order}, ${te_po.te_cID}, ${te_po.c_iId}, ${te_po.c_poId} );
.end for
