...
T_b("\n");
T_b("    ");
T_b("if ( 0 != pthread_cond_init( &nonbusy_wait_cond[ i ], 0 ) ) {");
T_b("\n");
T_b("      ");
T_b("/* error recovery TBD */");
T_b("\n");
T_b("    ");
T_b("}");
T_b("\n");
...
T_b("\n");
T_b("    ");
T_b("if ( 0 != pthread_mutex_init( &mutices[ i ], 0 ) ) {");
T_b("\n");
T_b("      ");
T_b("/* error recovery TBD */");
T_b("\n");
...
T_b("\n");
T_b("  ");
T_b("if ( 0 != pthread_mutex_lock( &mutices[ flavor ] ) ) {");
T_b("\n");
T_b("    ");
T_b("/* error recovery TBD */");
T_b("\n");
...
T_b("\n");
T_b("  ");
T_b("if ( 0 != pthread_mutex_unlock( &mutices[ flavor ] ) ) {");
T_b("\n");
T_b("    ");
T_b("/* error recovery TBD */");
T_b("\n");
...
T_b("\n");
T_b("      ");
T_b("if ( 0 != pthread_cond_timedwait(");
T_b("\n");
T_b("        ");
...
T_b("\n");
T_b("    ");
T_b("if ( 0 != pthread_cond_wait( dwc, &mutices[ SEMAPHORE_FLAVOR_NONBUSY ] ) ) {");
T_b("\n");
T_b("      ");
T_b("/* error recovery TBD */");
T_b("\n");
...
T_b("\n");
T_b("  ");
T_b("if ( 0 != pthread_cond_broadcast( dwc ) ) {");
T_b("\n");
T_b("    ");
T_b("/* error recovery TBD */");
T_b("\n");
...
T_b("\n");
T_b("  ");
T_b("if ( 0 != pthread_create( &pthread[ i - 1 ], 0, routine, &threadnumber[ i ] ) ) {");
T_b("\n");
T_b("    ");
T_b("/* error recovery TBD */");
T_b("\n");
...
T_b("\n");
T_b("    ");
T_b("if ( 0 != pthread_cond_destroy( &nonbusy_wait_cond[ i ] ) ) {");
T_b("\n");
T_b("      ");
T_b("/* error recovery TBD */");
T_b("\n");
...
T_b("\n");
T_b("    ");
T_b("if ( 0 != pthread_mutex_destroy( &mutices[ i ] ) ) {");
T_b("\n");
T_b("      ");
T_b("/* error recovery TBD */");
T_b("\n");
