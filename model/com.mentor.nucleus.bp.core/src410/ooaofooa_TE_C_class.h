...
struct ooaofooa_TE_C {
  ...
  c_t classes_file[ESCHER_SYS_MAX_STRING_LEN];  
  c_t functions_file[ESCHER_SYS_MAX_STRING_LEN];  
  i_t MaxObjExtent;  
  i_t MaxRelExtent;  
  i_t MaxSelectExtent;  
  i_t MaxSelfEvents;  
  ...
  c_t module_file[ESCHER_SYS_MAX_STRING_LEN];  
  c_t port_file[ESCHER_SYS_MAX_STRING_LEN];  
...
/* Note:  TE_C->TE_DT[R2086] not navigated */
