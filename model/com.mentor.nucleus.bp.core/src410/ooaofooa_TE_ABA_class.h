...
struct ooaofooa_TE_ABA {
  ...
  c_t ParameterDeclaration[ESCHER_SYS_MAX_STRING_LEN];  
  c_t ParameterDefinition[ESCHER_SYS_MAX_STRING_LEN];  
  c_t ParameterStructure[ESCHER_SYS_MAX_STRING_LEN];  
  c_t ParameterTrace[ESCHER_SYS_MAX_STRING_LEN];  
  c_t ParameterFormat[ESCHER_SYS_MAX_STRING_LEN];  
  c_t ParameterInvocation[ESCHER_SYS_MAX_STRING_LEN];  
  c_t ParameterAssignment[ESCHER_SYS_MAX_STRING_LEN];  
  c_t ParameterAssignmentBase[ESCHER_SYS_MAX_STRING_LEN];  
  c_t scope[ESCHER_SYS_MAX_STRING_LEN];  
  c_t GeneratedName[ESCHER_SYS_MAX_STRING_LEN];  
  c_t ReturnDataType[ESCHER_SYS_MAX_STRING_LEN];  
  i_t dimensions;  
