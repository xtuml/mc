...
struct ooaofooa_TE_DCI {
  ...
  c_t class_numbers[ESCHER_SYS_MAX_STRING_LEN];  
  c_t persist_union[ESCHER_SYS_MAX_STRING_LEN];  
  c_t task_list[ESCHER_SYS_MAX_STRING_LEN];  
  c_t task_numbers[ESCHER_SYS_MAX_STRING_LEN];  
  c_t max[ESCHER_SYS_MAX_STRING_LEN];  
  c_t max_models[ESCHER_SYS_MAX_STRING_LEN];  
  c_t init[ESCHER_SYS_MAX_STRING_LEN];  
  c_t array_name[ESCHER_SYS_MAX_STRING_LEN];  
