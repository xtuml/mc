...
struct ooaofooa_TE_IIR {
  ...
  c_t component_name[ESCHER_SYS_MAX_STRING_LEN];  
  c_t port_name[ESCHER_SYS_MAX_STRING_LEN];  
  c_t interface_name[ESCHER_SYS_MAX_STRING_LEN];  
  bool polymorphic;  
  c_t template_parameter_values[ESCHER_SYS_MAX_STRING_LEN];  
  c_t C2C[ESCHER_SYS_MAX_STRING_LEN];  
