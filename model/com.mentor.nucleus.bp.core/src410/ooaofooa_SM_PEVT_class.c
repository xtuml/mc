...
ooaofooa_SM_PEVT_instanceloader( Escher_iHandle_t instance, const c_t * avlstring[] )
{
  ...
  Escher_strcpy( self->localClassName, avlstring[ 4 ] );
  Escher_strcpy( self->localClassKL, avlstring[ 5 ] );
  Escher_strcpy( self->localEventMning, avlstring[ 6 ] );
