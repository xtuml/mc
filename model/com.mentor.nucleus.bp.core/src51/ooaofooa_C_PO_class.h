...
struct ooaofooa_C_PO {
  ...
  Escher_ObjectSet_s CL_POR_R4709_is_referenced_by;
};
...
#define ooaofooa_CL_POR_R4709_From_C_PO_is_referenced_by( C_PO ) ( &((C_PO)->CL_POR_R4709_is_referenced_by) )
/* Note:  C_PO->CL_POR[R4709] not navigated */
