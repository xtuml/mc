...
ooaofooa_TE_FILE_instanceloader( Escher_iHandle_t instance, const c_t * avlstring[] )
{
  ...
  self->mc3020sys_path = Escher_strcpy( self->mc3020sys_path, avlstring[ 26 ] );
  self->bridge_mark = Escher_strcpy( self->bridge_mark, avlstring[ 27 ] );
  self->system_mark = Escher_strcpy( self->system_mark, avlstring[ 28 ] );
  self->datatype_mark = Escher_strcpy( self->datatype_mark, avlstring[ 29 ] );
  self->event_mark = Escher_strcpy( self->event_mark, avlstring[ 30 ] );
  self->class_mark = Escher_strcpy( self->class_mark, avlstring[ 31 ] );
  self->domain_mark = Escher_strcpy( self->domain_mark, avlstring[ 32 ] );
  self->system_functions_mark = Escher_strcpy( self->system_functions_mark, avlstring[ 33 ] );
  self->arc_path = Escher_strcpy( self->arc_path, avlstring[ 34 ] );
  self->root_path = Escher_strcpy( self->root_path, avlstring[ 35 ] );
...
{
  ooaofooa_TE_FILE * self = (ooaofooa_TE_FILE *) instance;
  printf( "INSERT INTO TE_FILE VALUES ( '%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s' );\n",
    ...
    ( 0 != self->mc3020sys_path ) ? self->mc3020sys_path : "",
