...
ooaofooa_TE_CLASS * ooaofooa_class_insert_by_keylet( ooaofooa_TE_CLASS *, ooaofooa_TE_CLASS * );
...
ooaofooa_TE_CLASS * ooaofooa_class_sort_by_keylet( Escher_ObjectSet_s * );
...
c_t * ooaofooa_fx_get_auto_inc_get_hlimit_value_macro_name( ooaofooa_O_OBJ * );
c_t * ooaofooa_fx_get_auto_inc_get_llimit_value_macro_name( ooaofooa_O_OBJ * );
c_t * ooaofooa_fx_get_auto_inc_get_new_value_macro_name( ooaofooa_O_OBJ * );
c_t * ooaofooa_fx_get_auto_inc_id_mgmt_variable_name( ooaofooa_O_OBJ * );
