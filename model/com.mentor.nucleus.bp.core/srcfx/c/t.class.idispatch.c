...
T_b("_UserEventNoInstanceCallout( current_state, next_state, event_number );");
T_b("\n");
T_b("    ");
T_b("} else {");
T_b("\n");
...
T_b("          ");
T_b(base_arch_prefix->result);
T_b("_UserEventCantHappenCallout( current_state, next_state, event_number );");
T_b("\n");
if ( te_c->StateTrace ) {
T_b("          ");
