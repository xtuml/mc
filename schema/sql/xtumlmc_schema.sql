...
CREATE ROP REF_ID R503	FROM MC SM_SEME	(SMevt_ID, SM_ID)
			  TO 1  SM_SEVT	(SMevt_ID, SM_ID);
CREATE ROP REF_ID R504	FROM 1C SM_EIGN	(SMevt_ID, SM_ID, SMstt_ID)
			  TO 1  SM_SEME	(SMevt_ID, SM_ID, SMstt_ID);
CREATE ROP REF_ID R504	FROM 1C SM_CH	(SMevt_ID, SM_ID, SMstt_ID)
			  TO 1  SM_SEME	(SMevt_ID, SM_ID, SMstt_ID);
CREATE ROP REF_ID R504	FROM 1C SM_NSTXN	(SMevt_ID, SM_ID, SMstt_ID)
			  TO 1  SM_SEME	(SMevt_ID, SM_ID, SMstt_ID);
CREATE ROP REF_ID R505	FROM MC SM_TXN	(SM_ID)
			  TO 1  SM_SM	(SM_ID);
CREATE ROP REF_ID R506	FROM MC SM_TXN	(SMstt_ID, SM_ID)
...
CREATE ROP REF_ID R524	FROM MC SM_EVTDI	(DT_ID)
			  TO 1  S_DT	(DT_ID);
CREATE ROP REF_ID R525	FROM 1C SM_SEVT	(SM_ID, SMevt_ID)
			  TO 1  SM_EVT	(SM_ID, SMevt_ID);
CREATE ROP REF_ID R525	FROM 1C SM_PEVT	(SM_ID, SMevt_ID)
			  TO 1  SM_EVT	(SM_ID, SMevt_ID);
CREATE ROP REF_ID R526	FROM 1C SM_NLEVT	(SMevt_ID, SM_ID)
			  TO 1  SM_SEVT	(SMevt_ID, SM_ID);
CREATE ROP REF_ID R526	FROM 1C SM_LEVT	(SMevt_ID, SM_ID)
			  TO 1  SM_SEVT	(SMevt_ID, SM_ID);
CREATE ROP REF_ID R526	FROM 1C SM_SGEVT	(SMevt_ID, SM_ID)
			  TO 1  SM_SEVT	(SMevt_ID, SM_ID);
