 ...
 */
void
${relate_method.result}( ${super_te_class.GeneratedName} * supertype, ${sub_te_class.GeneratedName} * subtype )
{
  .if ( te_c.DetectEmpty )
 ...
 */
void
${unrelate_method.result}( ${super_te_class.GeneratedName} * supertype, ${sub_te_class.GeneratedName} * subtype )
{
  .if ( te_c.DetectEmpty )
  if ( (supertype == 0) || (subtype == 0) ) {
