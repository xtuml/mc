...
${externstatic} void ${link_method.name}( ${aone_te_class.GeneratedName} *, ${aoth_te_class.GeneratedName} *, ${assr_te_class.GeneratedName} * );
.else
...
${externstatic} void ${unlink_method.name}( ${aone_te_class.GeneratedName} *, ${aoth_te_class.GeneratedName} *, ${assr_te_class.GeneratedName} * );
.else
