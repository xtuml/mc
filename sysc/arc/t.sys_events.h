...
#define ${te_prefix.define_csw}ClearOoaEventFlags(X) (((X))->event_flags = 0)
...
#define ${te_prefix.define_csw}GetEventSrcObjectNumber(X) (((X))->source_object_number)
#define ${te_prefix.define_csw}SetEventSrcObjectNumber(X, Y) (((X))->source_object_number = (Y))

extern ${te_eq.base_event_type} * ${te_eq.allocate}( void );
extern ${te_eq.base_event_type} * ${te_eq.new}( const void * const, const ${te_eq.constant_type} * const );
extern ${te_eq.base_event_type} * ${te_eq.modify}( ${te_eq.base_event_type} *, const ${te_eq.constant_type} * const );
extern void ${te_eq.delete}( ${te_eq.base_event_type} * );
extern void ${te_prefix.symbolsw}InitializeOoaEventPool( void );
extern void ${te_prefix.result}xtUML_run( void );
extern void * ${te_instance.global_self}( void );
extern void ${te_eq.non_self}( ${te_eq.base_event_type} * );
extern void ${te_eq.self}( ${te_eq.base_event_type} * );
.if ( te_tim.timer_event_search_and_destroy )
extern bool ${te_eq.search_and_destroy}( ${te_eq.base_event_type} * );
.end if
.if ( te_sys.AUTOSAR )
extern void * ooa_loop( void * );
