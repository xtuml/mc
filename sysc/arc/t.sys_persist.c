...
static ${te_set.base_class} insts_inactive, links_inactive;
static struct { Escher_SetElement_s * head, * tail; } instlinks_active;
static ${te_set.element_type} inst_container[ ${te_persist.instance_cache_depth} ];
static ${te_set.element_type} link_container[ ${te_persist.link_cache_depth} ];
