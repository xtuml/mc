...
extern ${persist_check_mark.type} ${persist_check_mark.name}(
${persist_check_mark.arglist_types} );
extern ${persist_post_link.type} ${persist_post_link.name}(
${persist_post_link.arglist_types} );
extern void ${te_persist.remove}(
  const ${te_instance.handle},
  const ${te_typemap.domain_number_name},
  const ${te_typemap.object_number_name} );
extern i_t ${te_persist.commit}( void );
extern i_t ${te_persist.restore}( void );
extern void ${te_persist.factory_init}( void );
