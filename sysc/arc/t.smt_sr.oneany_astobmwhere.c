.//============================================================================
.// $RCSfile: t.smt_sr.oneany_astobmwhere.c,v $
.//
.// Notice:
...
.assign b = b + "${ws}while ( ( 0 == ${te_select_related.result_var} ) && ( 0 != ( ${te_lnk.left} = (${te_select_related.te_classGeneratedName} *) ${te_set.iterator_next}( &start_many_iterator ) ) ) ) {\n"
