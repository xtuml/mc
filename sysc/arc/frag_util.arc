...
${indent.result}  ${te_set.clear}( &${obj_var.VarName} );  /* ${obj_var.Name} */
      .end for
${indent.result}}
  ...
  .if ( special )
    ...
    .for each te_attr in te_attrs
      ...
      .else
        ...
        .assign cmp_element = "!${te_string.strcmp}(${selected_var_name}->${te_attr.GeneratedName}, ${te_attr.ParamBuffer})"
      .end if
