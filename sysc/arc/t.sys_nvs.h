...
extern i_t ${te_prefix.result}NVS_checksum( i_t, i_t );
extern i_t ${te_prefix.result}NVS_defrag( void );
extern i_t ${te_prefix.result}NVS_remove( u4_t, i_t, c_t const *, i_t );
extern i_t ${te_prefix.result}NVS_format( void );
extern i_t ${te_prefix.result}NVS_initialize( void );
extern i_t ${te_prefix.result}NVS_insert( u4_t, i_t, c_t const *, i_t );
extern i_t ${te_prefix.result}NVS_next( u4_t *, i_t, c_t *, i_t * );
extern i_t ${te_prefix.result}NVS_select( u4_t, i_t, c_t *, i_t );
extern i_t ${te_prefix.result}NVS_space_available( void );
extern i_t ${te_prefix.result}NVS_space_total( void );
extern i_t ${te_prefix.result}NVS_space_used( void );
extern i_t ${te_prefix.result}NVS_update( u4_t, i_t, c_t const *, i_t );
extern i_t ${te_prefix.result}NVS_version( i_t, i_t );
