 ...
 *
 */
extern void ${te_callout.initialization}f( void );
 ...
 */
extern void ${te_callout.pre_xtUML_initialization}f( void );
/* The following empty definition renders the callout hook invisible.
   Delete or comment out the following define to activate the in line
   hook for this callout.  */
 ...
 */
extern void ${te_callout.post_xtUML_initialization}f( void );
/* The following empty definition renders the callout hook invisible.
   Delete or comment out the following define to activate the in line
   hook for this callout.  */
 ...
 */
extern void ${te_callout.background_processing}f( void );
/* The following empty definition renders the callout hook invisible.
   Delete or comment out the following define to activate the in line
   hook for this callout.
   (activated by default...  Uncomment to deactivate.)
 ...
 */
extern void ${te_callout.pre_shutdown}f( void );
/* The following empty definition renders the callout hook invisible.
   Delete or comment out the following define to activate the in line
   hook for this callout.  */
 ...
 */
extern void ${te_callout.post_shutdown}f( void );
/* The following empty definition renders the callout hook invisible.
   Delete or comment out the following define to activate the in line
   hook for this callout.  */
 ...
 */
extern void ${te_callout.event_cant_happen}f( const ${te_typemap.state_number_name},
 ...
 * error).
 */
extern void ${te_callout.event_no_instance}f( const ${te_typemap.event_number_name} );
/* The following empty definition renders the callout hook invisible.
   Delete or comment out the following define to activate the in line
   hook for this callout.  */
 ...
 */
extern void ${te_callout.event_free_list_empty}f( void );
/* The following empty definition renders the callout hook invisible.
   Delete or comment out the following define to activate the in line
   hook for this callout.  */
 ...
 */
extern void ${te_callout.empty_handle_detected}f( c_t *, c_t * );
/* The following empty definition renders the callout hook invisible.
   Delete or comment out the following define to activate the in line
   hook for this callout.  */
 ...
 */
extern void ${te_callout.object_pool_empty}f( c_t *, c_t * );
/* The following empty definition renders the callout hook invisible.
   Delete or comment out the following define to activate the in line
   hook for this callout.  */
 ...
 */
extern void ${te_callout.node_list_empty}f( void );
/* The following empty definition renders the callout hook invisible.
   Delete or comment out the following define to activate the in line
   hook for this callout.  */
 ...
 */
extern void ${te_callout.interleaved_bridge_overflow}f( void );
/* The following empty definition renders the callout hook invisible.
   Delete or comment out the following define to activate the in line
   hook for this callout.  */
 ...
 */
extern void ${te_callout.self_event_queue_empty}f( void );
/* The following empty definition renders the callout hook invisible.
   Delete or comment out the following define to activate the in line
   hook for this callout.  */
 ...
 * interrogated and found to be empty.
 */
extern void ${te_callout.non_self_event_queue_empty}f( void );
/* The following empty definition renders the callout hook invisible.
   Delete or comment out the following define to activate the in line
   hook for this callout.  */
 ...
 */
extern void ${te_callout.persistence_error}f( i_t );
/* The following empty definition renders the callout hook invisible.
   Delete or comment out the following define to activate the in line
   hook for this callout.  */
