 ...
 */
void
${link_method.result}( ${assoc_te_class.GeneratedName} * left, ${assoc_te_class.GeneratedName} * right, ${assr_te_class.GeneratedName} * assr )
{
  .if ( te_c.DetectEmpty )
...
${set_aoth_referentials}\
  ...
  .else
    .if ( towards_aone )
  ${te_set.insert_element}( &left->${aone_assr_data.result}, assr ); /* RAL 7 */
    .else
  ${te_set.insert_element}( &right->${aone_assr_data.result}, assr ); /* RAL 8 */
    .end if
  .end if
  .if ( aoth.Mult == 0 )
    .if ( towards_aone )
  ...
  .else
    .if ( towards_aone )
  ${te_set.insert_element}( &right->${aoth_assr_data.result}, assr ); /* RAL 11 */
    .else
  ${te_set.insert_element}( &left->${aoth_assr_data.result}, assr ); /* RAL 12 */
    .end if
  .end if
${persist_relate.body}\
}
 ...
 */
void
${unlink_method.result}( ${assoc_te_class.GeneratedName} * left, ${assoc_te_class.GeneratedName} * right, ${assr_te_class.GeneratedName} * assr )
{
  .if ( te_c.DetectEmpty )
  if ( (left == 0) || (right == 0) || (assr == 0) ) {
...
${reset_referentials}\
  ...
  .else
    .if ( towards_aone )
  ${te_set.remove_element}( &left->${aone_assr_data.result}, assr ); /* RAU 7 */
    .else
  ${te_set.remove_element}( &right->${aone_assr_data.result}, assr ); /* RAU 8 */
  .end if
  .end if
  .if ( aoth.Mult == 0 )
    .if ( towards_aone )
  ...
  .else
    .if ( towards_aone )
  ${te_set.remove_element}( &right->${aoth_assr_data.result}, assr ); /* RAU 11 */
    .else
  ${te_set.remove_element}( &left->${aoth_assr_data.result}, assr ); /* RAU 12 */
    .end if
  .end if
