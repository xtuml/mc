...
extern void * ${te_ilb.interleave_bridge}( void (vfp)(void) );
extern void ${te_ilb.interleave_bridge_done}( void );
extern void ${te_ilb.dispatch}( void );
extern void * ${te_ilb.get_data}( void );
